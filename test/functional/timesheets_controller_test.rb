...
class TimesheetsControllerTest < ActionController::TestCase
  ...
  test "should create timesheet" do
    assert_difference('Timesheet.count') do
      post :create, timesheet: { conversation: @timesheet.conversation, day: @timesheet.day, study: @timesheet.study, teacher: @timesheet.teacher }
    end
  ...
  test "should update timesheet" do
    put :update, id: @timesheet, timesheet: { conversation: @timesheet.conversation, day: @timesheet.day, study: @timesheet.study, teacher: @timesheet.teacher }
    assert_redirected_to timesheet_path(assigns(:timesheet))
  end
